...
//  page += "<p align=center><IMG SRC='http://" + WiFiAddr + ":80/stream' style='width:300px; transform:rotate(180deg);'></p><br/><br/>";
//  page += "<p align=center><IMG id='screen' SRC='' style='width:300px; transform:rotate(180deg);'></p><br/><br/>";
// page+="<p align=center><img src=\"\" id=\"screen\" style='width:300px; transform:rotate(180deg);'></p><br/><br/>\n<script>\n setInterval(function() {\n     var myImageElement = document.getElementById('myImage');\n\t myImageElement.src = \"http://\" + window.location.href + \"/capture?rand=\" + Math.random();\n }, 100);</script>\n";
 page+="<p align=center><img src=\"\" id=\"screen\" style='width:300px; transform:rotate(180deg);'></p><br/><br/>\n";
...
//  page += "<button style=background-color:yellow;width:140px;height:40px onmousedown=getsend('ledon')><b>Light ON</b></button>\n";
 ...
 page += "</p>\n";
  ...
  page+="<script>\n";
    ...
    page+="f=()=>{j.src=window.location.href+\"ledon\"+\"?\"+Date.now()};\n"; 
    page+="setInterval(f,";
    page+=interval;
    page+=");\n";   
    page+=""; 
...
void startCameraServer(){
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        // httpd_register_uri_handler(camera_httpd, &our_capture_uri);
